...
import { ArrowLeft, CalendarIcon, EditIcon, Clock, User, AlertCircle, CheckCircle, XCircle, PauseCircle, PlayCircle } from 'lucide-react';
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                {workItem.workItemDescription || 'Không có mô tả'}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="text-sm">
                ...
                <p className="font-medium">{project.address || 'Chưa xác định'}</p>
              </div>
              <div className="text-sm">
